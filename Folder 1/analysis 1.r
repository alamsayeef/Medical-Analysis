#provide appropiate path here
d = read.csv("C:/Users/0295s/Desktop/sheet.csv") 
...
#look for further rectifications required
summary(d)

#attach the dataset, useful when you are working with just one dataset
attach(d)
